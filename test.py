...
if choice == "n":
	...
	accessToken = "Bearer YzJlNTViMTEtNTZjNC00NTY3LTkyNTgtZGM2NWM4MDhlM2MwOTA3OWIwMzQtZWQw_PE93_230463a1-5812-4f42-9411-a7901256c3a1"
...
# 6. Provide your MapQuest API consumer key.
        mapsAPIGetParameters = { 
                                "location": location, 
                                "key": "Td2YbO0oMn1JDUF9zuH2IB8SqSbNHYMK"
                               }
# 7. Provide the URL to the MapQuest address API.
        r = requests.get("https://www.mapquestapi.com/geocoding/v1/address?key=key&location=location", 
